...
export default function ListPlayersPage() {
  ...
  const [playersSelected, setPlayersSelected] = useState<Player[]>(fakePlayers)
  ...
  return (
    <Page>
      <Grid container sx={{display: 'flex', justifyContent: 'center', gap: (theme) => theme.spacing(4)}}>
        ...
        <Grid item>
          <Button variant='contained' size='large' disabled={countPlayersUsed < totalPlayers || budgetRemaining < 0}>Salvar</Button>
        </Grid>           
      </Grid>
    </Page>
  )
